...
describe("детерминизм ядра (property-based)", () => {
  it("одинаковые seed и последовательность команд дают идентичные снимки", () => {
    ...
    // Свойство считает шестьдесят прогонов: на машине слабее
    // разработческой оно выходит за отведённые по умолчанию пять секунд,
    // и честный прогон падает по таймауту (0.21.19).
  }, 60000);
