...
const KNIFE: WeaponStats = { id: "knife", category: "melee", apCost: 1, endsTurn: true, range: 1, requiresLOS: false, aimMod: 0, minDmg: 1, maxDmg: 1, crit: 0, critBonus: 0, envDmg: 0 };

function unit(partial: Partial<EntityState>): EntityState {
  return {
    id: 1, configId: "u", owner: 1, x: 2, y: 2, z: 1, dir: 1, ap: 2, maxAp: 2, mobility: 5,
    hp: 12, maxHp: 12, aim: 100, defense: 0, will: 40, vision: 12,
    weaponId: "knife", weaponIds: ["knife"], skillIds: [], obstacle: true, dead: false, flying: false,
    coverType: 0, overwatch: false, defending: false, movementSpent: 0, ...partial,
  };
}
...
describe("panic from a dead source (§15.3)", () => {
  it("a panicked unit does not flee from a dead source and burns AP", () => {
    ...
    const victim = unit({ id: 2, configId: "bogatyr", owner: 1, x: 2, y: 2, panic: { sourceId: 1, turnsLeft: 1 }, ap: 2 });
