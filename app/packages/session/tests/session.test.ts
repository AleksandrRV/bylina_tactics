...
describe("continueCampaign (0.21.0)", () => {
...
describe("suspend/resume campaign battle (0.20.17–0.21.0)", () => {
  ...
  it("suspend keeps the mission in the slot and resumes the battle", () => {
    ...
    // Контекст миссии — в слоте; навигационные поля чистые (0.21.0).
  ...
  it("detours through other modes from the menu do not lose the mission (0.21.0)", () => {
