...
Пошаговая тактическая игра. Версия **0.20.21**: тактический слой (умения классов, состояния, призывы, туман войны, дозор, разрушаемая среда), режим обучения из трёх миссий со свободным выбором и строгим пошаговым сценарием (каждое действие игрока и ход Нави предопределены и подсвечены, камера сама подводит цель шага), онбординг кампании и генералы; продолжение былины — через акцентную кнопку «Продолжить» в главном меню.
