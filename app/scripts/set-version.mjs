...
console.log("                     константы CORE_VERSION / APP_VERSION (из манифеста);");
console.log("                     независимые форматы SAVE_FORMAT_VERSION,");
console.log("                     REPLAY_FORMAT_VERSION / RULES_VERSION меняются осознанно,");
