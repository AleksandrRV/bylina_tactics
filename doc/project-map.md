...
| [game-design.md](game-design.md) | Замысел, режимы, дружина, противники, изобразительные принципы | Формулы, пакеты, payload, вёрстку, сюжет миссий | Понять, что за игра |
| [campaign.md](campaign.md) | Пролог (8 миссий), состав дружины, скрипты сцен, краевые случаи, задел типов миссий | Формулы, вёрстку, поля Zod | Писать миссию, сюжет, онбординг |
...
Одна тема — один файл. Изменили сетевой формат — только `network-protocol.md`. Изменили правило урона — только `game-rules.md`. Изменили экран — только `ui-design.md`. Сюжет и сценарий миссий кампании — только `campaign.md`. Если правка тянет три документа, сначала уточняют карту, а не копируют абзац.
