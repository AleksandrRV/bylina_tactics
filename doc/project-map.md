...
| `app/packages/ui/src/training-progress.ts` | Чистая логика обучения: порядок подсказок, авто-завершение хода, исход миссии (0.19.2; итог — 0.20.61) |
| `app/packages/ui/src/battle-cell-click.ts` | Разбор нажатия по полю боя: выбор, прицеливание, удар, рывок, умение по клетке, шаг — намерение без исполнения (0.20.63) |
